...
# ================= 1. 极致苹果美学引擎 (核心视觉回归) =================
st.set_page_config(page_title="肆叁叁起名社", page_icon="💐", layout="centered")
...
<style>
    ...
    .parent-label { color: #86868B !important; font-size: 15px; margin-bottom: 20px; font-weight: 500; }
...
with col_info:
    ...
    st.markdown(f'<div class="parent-label">亲本：{v_data["parents"]}</div>', unsafe_allow_html=True)
